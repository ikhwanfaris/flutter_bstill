...
extension ShadowView on Widget {
  Container shadow(
      ...
      Container(
        decoration: BoxDecoration(
          color: fillColor ?? AppTheme().primaryBackgroundColor,
          borderRadius: BorderRadius.all(Radius.circular(radius!)),
          boxShadow: <BoxShadow>[
            BoxShadow(
              offset: const Offset(1, 1),
              blurRadius: radius,
              color: AppTheme().shadowColor.withOpacity(shadowOpacity ?? 0.25),
            ),
          ],
        ),
        child: this,
  ...
  Container shadowWithoutRaidus({Color? fillColor, double? shadowOpacity}) =>
      Container(
          decoration: BoxDecoration(
            color: fillColor ?? AppTheme().primaryBackgroundColor,
            boxShadow: <BoxShadow>[
              BoxShadow(
                ...
                blurRadius: 10,
                color: AppTheme().grey.withOpacity(shadowOpacity ?? .2),
              ),
              BoxShadow(
                offset: const Offset(-3, 0),
                blurRadius: 15,
                color: AppTheme().grey.withOpacity(shadowOpacity ?? .1),
              )
            ],
          ),
          child: this);
              ...
              boxShadow: <BoxShadow>[
                BoxShadow(
                  ...
                  color: fillColor != null
                      ...
                      : AppTheme().grey.withOpacity(shadowOpacity ?? 0.25),
                ),
                BoxShadow(
...
extension BorderView on Widget {
  Container border({required double value, Color? color}) => Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(width: value, color: color ?? AppTheme().grey),
        ),
        child: this,
      );
    ...
    Color? color,
      ...
      Container(
        child: Container(
                decoration: BoxDecoration(
                  border: Border.all(
                      width: value, color: color ?? AppTheme().dividerColor),
...
// }
//
// extension GoTo on Widget {
//   Widget goTo(Widget page) => InkWell(
//         onTap: () {
//           NavigationService.instance
//               .navigateToRoute(MaterialPageRoute(builder: (ctx) => page));
//         },
//         child: this,
//       );
// }
